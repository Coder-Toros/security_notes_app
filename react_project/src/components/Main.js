  ...
  return (
    <div className="row">
      <div className="col-12">
        <div className="text">
          <p>
            <strong>SecurityNotes</strong> – сервис для обмена заметками.
            Создайте заметку, отправьте ссылку на заметку и ваш друг сможет ее
            просмотреть. После просмотра заметка будет удалена (или по истечении
            15 минут с момента создания).
          </p>
      ...
      <div className="col-12">
        <div className="text">
          <ul className="row button-list">
            ...
            <li className="col-6">
              <a href="/note" type=" button" className="btn btn-primary">
                Просмотреть note
              </a>
            </li>
          </ul>
